...
public final class ChannelContracts {
    ...
    public static final String CHANNEL_OUTBOUND_FRAME_PROTOCOL = "agentyard.channel-outbound-frame.v1";
    public static final String CHANNEL_OUTBOUND_FRAME_ACK_PROTOCOL = "agentyard.channel-outbound-frame-ack.v1";
