...
public final class DescriptorDefinitionDigests {
    ...
    public static String channelProviderDefinitionDigest(Map<String, Object> descriptor) {
        return AgentYardCanonicalJson.sha256ValueDigest(channelProviderDefinitionDigestInput(descriptor));
    }
    ...
    public static String channelProviderDefinitionDigest(
        ...
        return AgentYardCanonicalJson.sha256ValueDigest(
    ...
    public static String channelProviderDefinitionCanonicalJson(Map<String, Object> descriptor) {
        return AgentYardCanonicalJson.canonicalizeValue(channelProviderDefinitionDigestInput(descriptor));
    }

    public static byte[] channelProviderDefinitionCanonicalBytes(Map<String, Object> descriptor) {
        return AgentYardCanonicalJson.canonicalValueBytes(channelProviderDefinitionDigestInput(descriptor));
    }
    ...
    public static String toolConnectorDefinitionDigest(Map<String, Object> descriptor) {
        return AgentYardCanonicalJson.sha256ValueDigest(toolConnectorDefinitionDigestInput(descriptor));
    }
    ...
    public static String toolConnectorDefinitionCanonicalJson(Map<String, Object> descriptor) {
        return AgentYardCanonicalJson.canonicalizeValue(toolConnectorDefinitionDigestInput(descriptor));
    }

    public static byte[] toolConnectorDefinitionCanonicalBytes(Map<String, Object> descriptor) {
        return AgentYardCanonicalJson.canonicalValueBytes(toolConnectorDefinitionDigestInput(descriptor));
    }
