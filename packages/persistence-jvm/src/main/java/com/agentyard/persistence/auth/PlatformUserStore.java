package com.agentyard.persistence.auth;
...
import static com.agentyard.persistence.jooq.Tables.PLATFORM_USER;
import static com.agentyard.persistence.jooq.Tables.PLATFORM_USER_ROLE_BINDING;
...
public final class PlatformUserStore {
    ...
    private PlatformUserData mapUser(com.agentyard.persistence.jooq.tables.records.PlatformUserRecord record) {
        return new PlatformUserData(
            record.getId(),
            record.getUsername(),
