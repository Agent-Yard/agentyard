...
SESSION_ID_HEADER = "X-AgentYard-Session-Id"
WORKFLOW_ID_HEADER = "X-AgentYard-Workflow-Id"
CUSTOMER_ID_HEADER = "X-AgentYard-Customer-Id"
USER_ID_HEADER = "X-AgentYard-User-Id"
...
def configure_structured_logging(service_name: str, level_env_var: str, logger_name: str | None = None) -> logging.Logger:
    ...
    log_format = os.getenv("AGENTYARD_LOG_FORMAT", "json").strip().lower() or "json"
    renderer: Any = (
