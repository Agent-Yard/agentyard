...
LYNXUS_CHANNEL_GATEWAY_DATABASE="${LYNXUS_CHANNEL_GATEWAY_DATABASE:-lynxus_channel_gateway}"
LYNXUS_KNOWLEDGE_DATABASE="${LYNXUS_KNOWLEDGE_DATABASE:-lynxus_knowledge}"
LYNXUS_AGENT_RUNTIME_DATABASE="${LYNXUS_AGENT_RUNTIME_DATABASE:-lynxus_agent_runtime}"
...
create_database_if_missing "$LYNXUS_CHANNEL_GATEWAY_DATABASE" "$LYNXUS_APP_DATABASE_USER"
create_database_if_missing "$LYNXUS_KNOWLEDGE_DATABASE" "$LYNXUS_APP_DATABASE_USER"
create_database_if_missing "$LYNXUS_AGENT_RUNTIME_DATABASE" "$LYNXUS_APP_DATABASE_USER"
