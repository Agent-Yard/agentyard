...
import com.agentyard.platform.extension.ExtensionDefinitionService.InternalCredentialRoutingFacts;
import com.agentyard.platform.integration.IntegrationCredentialCrypto.EncryptedCredential;
...
import com.agentyard.platform.integration.IntegrationDtos.RuntimeIntegrationCredentialDto;
...
public class IntegrationAccountService {
    private static final String ACCOUNT_CONFIG_SCHEMA_ID = "https://agentyard.local/schemas/integration-account-config.schema.json";
