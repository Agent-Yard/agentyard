...
public class InternalChannelOutboundFrameStreamController {
    ...
    public SseEmitter stream(
        ...
        @RequestHeader(name = "X-AgentYard-Last-Acked-Final-Sequence", required = false) Long lastAckedFinalSequence,
        @RequestHeader(name = "X-AgentYard-Last-Acked-Session-Id", required = false) String lastAckedSessionId,
        @RequestHeader(name = "X-AgentYard-Last-Acked-Session-Message-Id", required = false) String lastAckedSessionMessageId,
        @RequestHeader(name = "X-AgentYard-Max-Final-Replay-Frames", required = false) Integer maxFinalReplayFrames
    ) {
