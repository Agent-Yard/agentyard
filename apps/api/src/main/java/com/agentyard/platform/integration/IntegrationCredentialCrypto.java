...
public class IntegrationCredentialCrypto {
    ...
    public IntegrationCredentialCrypto(
        ...
        @Value("${agentyard.integration.credentials.encryption-key:}") String rawKey
    ) {
    ...
    public EncryptedCredential encrypt(Map<String, Object> credential) {
        ...
        if (rawKey.isBlank()) {
            throw new IllegalStateException("agentyard.integration.credentials.encryption-key must be configured before storing integration credentials");
        }
        try {
    ...
    public Map<String, Object> decrypt(String ciphertext) {
        ...
        if (rawKey.isBlank()) {
            throw new IllegalStateException("agentyard.integration.credentials.encryption-key must be configured before reading integration credentials");
        }
        try {
