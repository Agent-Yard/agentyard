package com.agentyard.worker.logging;
...
public final class WorkerLogContext {
    ...
    private static String resolveInstanceId() {
        String instanceId = System.getenv("AGENTYARD_INSTANCE_ID");
        return blankToNull(instanceId) == null ? "agentyard-worker-instance" : instanceId.trim();
    }
