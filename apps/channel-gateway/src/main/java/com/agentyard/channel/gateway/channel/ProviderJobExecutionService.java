...
public class ProviderJobExecutionService {
    ...
    public ProviderJobExecutionService(
        ...
        @Value("${agentyard.channel-gateway.provider-jobs.scan-limit:50}") int scanLimit
    ) {
    ...
    @Scheduled(fixedDelayString = "${agentyard.channel-gateway.provider-jobs.scan-fixed-delay-ms:30000}")
