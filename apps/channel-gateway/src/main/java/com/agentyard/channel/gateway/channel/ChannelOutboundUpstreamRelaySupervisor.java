...
import com.agentyard.channel.gateway.channel.ChannelOutboundApiFrameStreamClient.StreamHandler;
import com.agentyard.channel.gateway.channel.ChannelOutboundApiFrameStreamClient.StreamRequest;
...
public class ChannelOutboundUpstreamRelaySupervisor {
    ...
    @Scheduled(fixedDelayString = "${agentyard.channel-gateway.outbound-relay.scan-fixed-delay:PT5S}")
