...
public class ChannelOutboundExtensionAccessService {
    ...
    public ExtensionDescriptor validateHeaders(ChannelOutboundExtensionHeaders headers) {
        ...
        String registrationId = requireText(headers.registrationId(), "X-AgentYard-Extension-Registration-Id");
        String descriptorType = requireText(headers.descriptorType(), "X-AgentYard-Extension-Descriptor-Type");
        String providerType = requireText(headers.descriptorId(), "X-AgentYard-Extension-Descriptor-Id");
