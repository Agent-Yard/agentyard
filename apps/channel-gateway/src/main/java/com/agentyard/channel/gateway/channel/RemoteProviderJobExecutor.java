...
import com.agentyard.contracts.channel.ChannelContracts.ChannelRunJobPayload;
import com.agentyard.contracts.channel.ChannelContracts.ChannelRunJobRequest;
import com.agentyard.contracts.channel.ChannelContracts.ChannelRunJobResponse;
...
public class RemoteProviderJobExecutor implements ProviderJobExecutor {
    ...
    public ProviderJobExecutionResult run(ProviderJobClaim claim) throws Exception {
        ...
        AgentYardExtensionHttp.descriptorLevelHeaders(
        ...
        for (NormalizedChannelInboundTurn turn : body.inboundTurns()) {
            ...
            if (dispatchResult.status() != com.agentyard.contracts.channel.ChannelContracts.ChannelInboundTurnStatus.DUPLICATE) {
                ingested++;
            }
        }
