...
final class FeishuLongConnectionManager {
    ...
    @Scheduled(
        initialDelayString = "${lynxus.channel-gateway.feishu.long-connection.reconcile-initial-delay-ms:30000}",
        fixedDelayString = "${lynxus.channel-gateway.feishu.long-connection.reconcile-fixed-delay-ms:30000}"
    )
