...
public class ChannelOutboundExtensionController {
    ...
    public ChannelOutboundExtensionSubscriptionService.ChannelOutboundFrameSubscriptionList subscriptions(
        @RequestHeader(name = LynxusExtensionHeaders.REGISTRATION_ID) String registrationId,
        @RequestHeader(name = LynxusExtensionHeaders.DESCRIPTOR_TYPE) String descriptorType,
        @RequestHeader(name = LynxusExtensionHeaders.DESCRIPTOR_ID) String descriptorId
    ) {
    ...
    public SseEmitter stream(
        ...
        @RequestHeader(name = "X-Lynxus-Last-Acked-Final-Sequence", required = false) Long diagnosticLastAckedFinalSequence
    ) {
